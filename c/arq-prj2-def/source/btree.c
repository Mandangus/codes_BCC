...
struct BTreeNode
{   //  lixo será adicionado posteriormente na escrita para o disco
    char folha;
...
enum RETURN_VALUES{//flags usadas no insert
    PROMOTION=0,
    NO_PROMOTION,
    ERROR
};

enum RETURN_VALUES_SEARCH{//flags usadas no search
    NOT_FOUND=-1,
};

//  escrita e leitura do header da B-tree //
...
//  escrita e leitura de um nó na B-tree //
...
// search básico parecido com o da árvore binária //
...
// função de utilidade para o insert no momento que precisamos splitar páginas
...
// inserindo a chave em um nó já adequado e fazendo as devidas manipulações
...
//criando uma árvore B com o lixo para completar o tamanho da página
...
// função de travessia pela b-tree usada também para debugar o código
